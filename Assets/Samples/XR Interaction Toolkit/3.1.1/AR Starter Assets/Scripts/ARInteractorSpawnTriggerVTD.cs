...
namespace UnityEngine.XR.Interaction.Toolkit.Samples.ARStarterAssets
{
    ...
    /// </summary>
    public class ARInteractorSpawnTriggerVTD : MonoBehaviour
    {

        //cbc additions
        [SerializeField] private bool StopRunningSpawner = false;
        [SerializeField] private GameObject _xrOriginRig;
        [SerializeField] private string _trackables = "Trackables";
        ...
        void Update()
        {
            ...
            if (m_AttemptSpawn)
            {
                ...
                if (!isPointerOverUI && m_ARInteractor.TryGetCurrentARRaycastHit(out var arRaycastHit))
                {
                    ...
                    //cbc update to deactivate Object Spawner Script
                    //original = m_ObjectSpawner.TrySpawnObject(arRaycastHit.pose.position, arPlane.normal);
                    if (!StopRunningSpawner)
                    {
                        StopRunningSpawner = m_ObjectSpawner.TrySpawnObject(arRaycastHit.pose.position, arPlane.normal);
                        TurnOffPlanes();
                    }
                }
        ...
        {
            Transform TrackableGO;
            TrackableGO = _xrOriginRig.transform.Find(_trackables);
            TrackableGO.gameObject.SetActive(false);
        }
    }
}
#endif
